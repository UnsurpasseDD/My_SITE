        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <input type="hidden"  name="id" value="<?=$id?>">
                    <div class="col">
                        <label for="formGroupExampleInput" class="form-label">Lогин</label>
                        <input type="text" class="form-control" name="login" value="<?=$username?>" id="formGroupExampleInput" placeholder="Придумайте логин">
                    </div>
                    <div class="col">
                        <label for="exampleInputEmail1" class="form-label" >Email</label>
                        <input disabled type="email" class="form-control" name="email" value="<?=$user['email'];?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Напиши Почту...">
                    </div>
                    <div class="col">
